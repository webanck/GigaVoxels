...
#include "SphereProducer.hcu"

template <typename NodeRes, typename BrickRes, uint BorderSize, typename VolumeTreeType>
class SphereProducer
	: public gigavoxels::IProvider< 0, SphereProducer<NodeRes, BrickRes, BorderSize, VolumeTreeType> >
	, public gigavoxels::IProvider< 1, SphereProducer<NodeRes, BrickRes, BorderSize, VolumeTreeType> >
{
public:

	//! Typedef the kernel part of the shader
	typedef SphereProducerKernel< NodeRes, BrickRes, BorderSize,
