...
::updateSymbols()
{
	...
	//GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( k_VTC_TimeStampArray, (&d_TimeStampArray->getDeviceArray()), sizeof( d_TimeStampArray->getDeviceArray() ), 0, cudaMemcpyHostToDevice ) );
	GvCore::Array3DKernelLinear< uint > timeStampArrayDevice = d_TimeStampArray->getDeviceArray();
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( k_VTC_TimeStampArray, &timeStampArrayDevice, sizeof( d_TimeStampArray->getDeviceArray() ), 0, cudaMemcpyHostToDevice ) );
}
