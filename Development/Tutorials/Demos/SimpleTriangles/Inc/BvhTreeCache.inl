...
::updateSymbols()
{
	...
	//GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( k_VTC_NTTimeStampArray, ( &nodesCacheManager->getdTimeStampArray()->getDeviceArray() ), sizeof( nodesCacheManager->getdTimeStampArray()->getDeviceArray() ), 0, cudaMemcpyHostToDevice ) );
	GvCore::Array3DKernelLinear< uint > nodeCacheArrayDevice = nodesCacheManager->getdTimeStampArray()->getDeviceArray();
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( k_VTC_NTTimeStampArray, &nodeCacheArrayDevice, sizeof( nodesCacheManager->getdTimeStampArray()->getDeviceArray() ), 0, cudaMemcpyHostToDevice ) );

	// Copy brick's time stamp buffer
	// Linux : taking address of temporary is error...
	//GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( k_VTC_BTimeStampArray,	( &bricksCacheManager->getdTimeStampArray()->getDeviceArray() ), sizeof( bricksCacheManager->getdTimeStampArray()->getDeviceArray() ), 0, cudaMemcpyHostToDevice ) );
	GvCore::Array3DKernelLinear< uint > brickCacheArrayDevice = bricksCacheManager->getdTimeStampArray()->getDeviceArray();
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( k_VTC_BTimeStampArray, &brickCacheArrayDevice, sizeof( bricksCacheManager->getdTimeStampArray()->getDeviceArray() ), 0, cudaMemcpyHostToDevice ) );

	// Unified
	//
	// Copy request buffer
	// Linux : taking address of temporary is error...
	//GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( k_VTC_UpdateBufferArray,	( &(d_UpdateBufferArray->getDeviceArray()) ), sizeof( d_UpdateBufferArray->getDeviceArray() ), 0, cudaMemcpyHostToDevice ) );
	GvCore::Array3DKernelLinear< uint > requestBufferArray = d_UpdateBufferArray->getDeviceArray();
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( k_VTC_UpdateBufferArray,	&requestBufferArray, sizeof( d_UpdateBufferArray->getDeviceArray() ), 0, cudaMemcpyHostToDevice ) );
