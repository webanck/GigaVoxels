...
void SampleCore::init()
{
	...
	dataRepository += QDir::separator();
	dataRepository += QString( "GvShadowMap" );
	dataRepository += QDir::separator();
	QString vertexShaderFilename = dataRepository + QString( "shadowMapping_1stPass_vert.glsl" );
	QString fragmentShaderFilename = dataRepository + QString( "shadowMapping_1stPass_frag.glsl" );
	...
	bool statusOK = _shadowMap->initialize();
}
...
void SampleCore::draw()
{
	...
	//--------------------------------------------------------
	{
		//// Extract OpenGL transformations
		...
		//GLuint _shadowMapping1stPassShaderProgram = 0;
		//
		//GLuint location = glGetUniformLocation( _shadowMapping1stPassShaderProgram, "uModelViewMatrix" );
		//if ( location >= 0 )
		//{
		//	glUniformMatrix4fv( location, 1, GL_FALSE, modelViewMatrix._array );
		//}

		//location = glGetUniformLocation( _shadowMapping1stPassShaderProgram, "uProjectionMatrix" );
		//if ( location >= 0 )
		//{
		...
		//GLuint _shadowMapping2ndPassShaderProgram = 0;

		//location = glGetUniformLocation( _shadowMapping2ndPassShaderProgram, "uModelViewMatrix" );
		//if ( location >= 0 )
		//{
		//	glUniformMatrix4fv( location, 1, GL_FALSE, modelViewMatrix._array );
		//}

		//location = glGetUniformLocation( _shadowMapping2ndPassShaderProgram, "uProjectionMatrix" );
		//if ( location >= 0 )
		//{
		//	glUniformMatrix4fv( location, 1, GL_FALSE, projectionMatrix._array );
		//}

		///*location = glGetUniformLocation( _shadowMapping2ndPassShaderProgram, "uNormalMatrix" );
		//if ( location >= 0 )
		//{
		//	glUniformMatrix3fv( location, 1, GL_FALSE, projectionMatrix._array );
		//}*/

		//location = glGetUniformLocation( _shadowMapping2ndPassShaderProgram, "uShadowMatrix" );
		//if ( location >= 0 )
		//{
		...
		//	//shadowMatrix = biasMatrix * lightProjectionMatrix * lightViewMatrix * modelMatrix;

		//	glUniformMatrix4fv( location, 1, GL_FALSE, shadowMatrix._array );
		//}

		//location = glGetUniformLocation( _shadowMapping2ndPassShaderProgram, "uShadowMap" );
		//if ( location >= 0 )
		//{
	...
	glEnable( GL_DEPTH_TEST );
	_shadowMap->render( viewMatrix, projectionMatrix, viewport );
	glDisable( GL_DEPTH_TEST );
