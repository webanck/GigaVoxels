 ...
 * 
 ******************************************************************************/
extern "C" GVSHADOWMAP_EXPORT GvvPluginInterface* createPlugin( GvvPluginManager& pManager )
{
...
void Plugin::initialize()
{
	...
	editorWindow->registerEditorFactory( SampleCore::cTypeName, &GvvPipelineEditor::create );
