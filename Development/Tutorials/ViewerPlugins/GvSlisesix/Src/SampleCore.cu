...
void SampleCore::setCeilingState( bool pFlag )
{
	...
	// Update device memory
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cCeilingState, &_ceilingState, sizeof( _ceilingState ), 0, cudaMemcpyHostToDevice ) );
...
void SampleCore::setFloorState( bool pFlag )
{
	...
	// Update device memory
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cFloorState, &_floorState, sizeof( _floorState ), 0, cudaMemcpyHostToDevice ) );
...
void SampleCore::setColumnsState( bool pFlag )
{
	...
	// Update device memory
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cColumnsState, &_columnsState, sizeof( _columnsState ), 0, cudaMemcpyHostToDevice ) );
...
void SampleCore::setMonsterState( bool pFlag )
{
	...
	// Update device memory
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cMonsterState, &_monsterState, sizeof( _monsterState ), 0, cudaMemcpyHostToDevice ) );
...
void SampleCore::setEyePosition( float pX, float pY, float pZ )
{
	...
	// Update device memory
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cEyePos, &_eyePosition, sizeof( _eyePosition ), 0, cudaMemcpyHostToDevice ) );
...
void SampleCore::setMapScale( float pValue )
{
	...
	// Update device memory
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cMapScale, &_mapScale, sizeof( _mapScale ), 0, cudaMemcpyHostToDevice ) );
...
void SampleCore::setBumpMapping( bool pFlag )
{
	...
	// Update device memory
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cUseBumpMapping, &_useBumpMapping, sizeof( _useBumpMapping ), 0, cudaMemcpyHostToDevice ) );
...
void SampleCore::setAmbientOcclusion( bool pFlag )
{
	...
	// Update device memory
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cUseAmbientOcclusion, &_useAmbientOcclusion, sizeof( _useAmbientOcclusion ), 0, cudaMemcpyHostToDevice ) );
...
void SampleCore::setSoftShadows( bool pFlag )
{
	...
	// Update device memory
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cUseSoftShadows, &_useSoftShadows, sizeof( _useSoftShadows ), 0, cudaMemcpyHostToDevice ) );
