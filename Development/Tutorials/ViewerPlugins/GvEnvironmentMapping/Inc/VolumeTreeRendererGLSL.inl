...
,	_refractionCoeff( 0.0f )
{
	...
	//QString vertexShaderFilename = dataRepository + QDir::separator() + QString( "Shaders" ) + QDir::separator() + QString( "GvRendererGLSL" ) + QDir::separator() + QString( "rayCastVert.glsl" );
