...
void SampleCore::setNoiseShellWidth( float pValue )
{
	...
	// Update device memory
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cNoiseShellWidth, &_noiseShellWidth, sizeof( _noiseShellWidth ), 0, cudaMemcpyHostToDevice ) );
}
...
void SampleCore::setNoiseShellWidthUpperBound( float pValue )
{
	...
	// Update device memory
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cNoiseShellWidthUpperBound, &_noiseShellWidthUpperBound, sizeof( _noiseShellWidthUpperBound ), 0, cudaMemcpyHostToDevice ) );
...
void SampleCore::setNoiseFunctionModifier( int pValue )
{
	...
	// Update device memory
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cNoiseFunctionModifier, &_noiseFunctionModifier, sizeof( _noiseFunctionModifier ), 0, cudaMemcpyHostToDevice ) );
}
...
void SampleCore::setDisplacement( int pValue )
{
	...
	// Update device memory
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cNoiseDisplacement, &_noiseDisplacement, sizeof( _noiseDisplacement ), 0, cudaMemcpyHostToDevice ) );
}
...
void SampleCore::setFillTheShape( int pValue )
{
	...
	// Update device memory
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cNoiseFillTheShape, &_noiseFillTheShape, sizeof( _noiseFillTheShape ), 0, cudaMemcpyHostToDevice ) );
...
void SampleCore::setAnimation( bool pFlag )
{
	...
	// Update device memory
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cAnimation, &_animate, sizeof( _animate ), 0, cudaMemcpyHostToDevice ) );
}
