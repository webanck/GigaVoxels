...
private slots:
	 ...
	 */
	void on__lightXDoubleSpinBox_valueChanged( double pValue );

	/**
	 * Slot called when light position Y value has changed
	 */
	void on__lightYDoubleSpinBox_valueChanged( double pValue );

	/**
	 * Slot called when light position Z value has changed
	 */
	void on__lightZDoubleSpinBox_valueChanged( double pValue );

	/**
	 * Slot called when shader's gradient step value has changed
	 */
	void on__shaderGradientStepDoubleSpinBox_valueChanged( double pValue );

	/**
	 * Slot called when shader's full opacity distance value has changed
	 */
	void on__shaderFullOpacityDistanceDoubleSpinBox_valueChanged( double pValue );

	/**
	 * Slot called when shader's threshold value has changed
	 */
	void on__shaderThresholdDoubleSpinBox_valueChanged( double pValue );
