...
{
	_runAnimation = run;
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( Particles::cRunAnimation, &_runAnimation, sizeof( _runAnimation ), 0, cudaMemcpyHostToDevice ) );
}
...
{
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( Particles::cGravity, &gravity, sizeof( gravity ), 0, cudaMemcpyHostToDevice ) );
}
...
{
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( Particles::cRebound, &rebound, sizeof( rebound ), 0, cudaMemcpyHostToDevice ) );
}
...
void SampleCore::setAmbient( float pValue )
{
	...
	// Update device memory
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cAmbient, &_ambient, sizeof( _ambient ), 0, cudaMemcpyHostToDevice ) );
}
...
void SampleCore::setDiffuse( float pValue )
{
	...
	// Update device memory
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cDiffuse, &_diffuse, sizeof( _diffuse ), 0, cudaMemcpyHostToDevice ) );
}
...
void SampleCore::setSpecular( float pValue )
{
	...
	// Update device memory
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cSpecular, &_specular, sizeof( _specular ), 0, cudaMemcpyHostToDevice ) );
}
...
void SampleCore::setTorusRadius( float pValue )
{
	...
	// Update device memory
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cTorusRadius, &_torusRadius, sizeof( _torusRadius ), 0, cudaMemcpyHostToDevice ) );
...
void SampleCore::setTubeRadius( float pValue )
{
	...
	// Update device memory
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cTubeRadius, &_tubeRadius, sizeof( _tubeRadius ), 0, cudaMemcpyHostToDevice ) );
...
void SampleCore::setNoiseMaxFrequency( unsigned int pValue )
{
	...
	// Update device memory
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cNoiseMaxFrequency, &_noiseMaxFrequency, sizeof( _noiseMaxFrequency ), 0, cudaMemcpyHostToDevice ) );
