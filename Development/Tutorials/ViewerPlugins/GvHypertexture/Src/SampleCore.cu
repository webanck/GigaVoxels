...
void SampleCore::setThickness( float pValue )
{
	...
	// Update device memory
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cThickness, &_thickness, sizeof( _thickness ), 0, cudaMemcpyHostToDevice ) );
...
void SampleCore::setA( float pValue )
{
	...
	// Update device memory
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cA, &_a, sizeof( _a ), 0, cudaMemcpyHostToDevice ) );
...
void SampleCore::setB( float pValue )
{
	...
	// Update device memory
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cB, &_b, sizeof( _b ), 0, cudaMemcpyHostToDevice ) );
...
void SampleCore::setEpsillon( float pValue )
{
	...
	// Update device memory
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cEpsillon, &_epsillon, sizeof( _epsillon ), 0, cudaMemcpyHostToDevice ) );
