...
typedef GvStructure::GvVolumeTree< DataType,
	NodeRes, BrickRes >		VolumeTreeType;

// Defines the type of the producer
typedef Producer< DataType,
...
public:
	 ...
	 * ...
	 */
	float getShaderOpacityCorrection() const;
	void setShaderOpacityCorrection( float pValue );
	...
	bool hasBrickGigaVoxelsRendering() const;
	void setBrickGigaVoxelsRendering( bool pFlag );
	bool hasBrickOpenGLVBORendering() const;
	void setBrickOpenGLVBORendering( bool pFlag );
	void initializeBrick();
	float getBrickPointSize() const;
	void setBrickPointSize( float pValue );
	float getVoxelScale() const;
	void setVoxelScale( float pValue );
...
protected:
	 ...
	 * ...
	 */
	float _shaderOpacityCorrection;
	unsigned int _brickNbPoints;
	bool _hasBrickDrawOneSlice;
	bool _hasBrickGigaVoxelsRendering;
	bool _hasBrickOpenGLVBORendering;
	float _voxelScale;
