...
class Producer
	: public GvCore::GvIProvider< 0, Producer< NodeRes, BrickRes, BorderSize, VolumeTreeType > >
	, public GvCore::GvIProvider< 1, Producer< NodeRes, BrickRes, BorderSize, VolumeTreeType > >
{
