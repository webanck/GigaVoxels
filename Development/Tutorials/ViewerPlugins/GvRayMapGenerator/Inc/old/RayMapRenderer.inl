...
RayMapRenderer< TVolumeTreeType, TVolumeTreeCacheType, TProducerType, TSampleShader >
::RayMapRenderer( TVolumeTreeType* pVolumeTree, TVolumeTreeCacheType* pVolumeTreeCache, TProducerType* pProducer )
:	GvRenderer::GvVolumeTreeRenderer< TVolumeTreeType, TVolumeTreeCacheType, TProducerType >( pVolumeTree, pVolumeTreeCache, pProducer )
,	_graphicsInteroperabiltyHandler( NULL )
,	_rayMapResource( NULL )
{
	GV_CHECK_CUDA_ERROR( "RayMapRenderer::RayMapRenderer prestart" );
	...
	_graphicsInteroperabiltyHandler = new GvRenderer::GvGraphicsInteroperabiltyHandler();
}
 ...
 ******************************************************************************/
template< typename TVolumeTreeType, typename TVolumeTreeCacheType, typename TProducerType, typename TSampleShader >
GvRenderer::GvGraphicsInteroperabiltyHandler* RayMapRenderer< TVolumeTreeType, TVolumeTreeCacheType, TProducerType, TSampleShader >
 ...
 ******************************************************************************/
template< typename TVolumeTreeType, typename TVolumeTreeCacheType, typename TProducerType, typename TSampleShader >
void RayMapRenderer< TVolumeTreeType, TVolumeTreeCacheType, TProducerType, TSampleShader >
::initializeCuda()
{
 ...
 ******************************************************************************/
template< typename TVolumeTreeType, typename TVolumeTreeCacheType, typename TProducerType, typename TSampleShader >
bool RayMapRenderer< TVolumeTreeType, TVolumeTreeCacheType, TProducerType, TSampleShader >
::connect( GvRenderer::GvGraphicsInteroperabiltyHandler::GraphicsResourceSlot pGraphicsResourceSlot, GLuint pBuffer )
{
...
template< typename TVolumeTreeType, typename TVolumeTreeCacheType, typename TProducerType, typename TSampleShader >
bool RayMapRenderer< TVolumeTreeType, TVolumeTreeCacheType, TProducerType, TSampleShader >
::connect( GvRenderer::GvGraphicsInteroperabiltyHandler::GraphicsResourceSlot pGraphicsResourceSlot, GLuint pImage, GLenum pTarget )
{
...
template< typename TVolumeTreeType, typename TVolumeTreeCacheType, typename TProducerType, typename TSampleShader >
bool RayMapRenderer< TVolumeTreeType, TVolumeTreeCacheType, TProducerType, TSampleShader >
::disconnect( GvRenderer::GvGraphicsInteroperabiltyHandler::GraphicsResourceSlot pGraphicsResourceSlot )
{
...
::doRender( const float4x4& modelMatrix, const float4x4& viewMatrix, const float4x4& projMatrix )
{
	...
	GvRenderer::GvRendererContext viewContext;
	...
	GV_CUDA_SAFE_CALL(cudaMemcpyToSymbol(GvRenderer::k_voxelSizeMultiplier, (&voxelSizeMultiplier), sizeof(voxelSizeMultiplier), 0, cudaMemcpyHostToDevice));
	 ...
	 ******************************************************************************/
	template< typename TVolumeTreeType, typename TVolumeTreeCacheType, typename TProducerType, typename TSampleShader >
	float RayMapRenderer< TVolumeTreeType, TVolumeTreeCacheType, TProducerType, TSampleShader >
...
::bindGraphicsResources()
{
	...
	std::vector< std::pair< GvRenderer::GvGraphicsInteroperabiltyHandler::GraphicsResourceSlot, GvRenderer::GvGraphicsResource* > >& graphicsResources = _graphicsInteroperabiltyHandler->editGraphicsResources();
	for ( int i = 0; i < graphicsResources.size(); i++ )
	{
		// Get current graphics resources info
		std::pair< GvRenderer::GvGraphicsInteroperabiltyHandler::GraphicsResourceSlot, GvRenderer::GvGraphicsResource* >& graphicsResourceInfo = graphicsResources[ i ];
		GvRenderer::GvGraphicsInteroperabiltyHandler::GraphicsResourceSlot graphicsResourceSlot = graphicsResourceInfo.first;
		GvRenderer::GvGraphicsResource* graphicsResource  = graphicsResourceInfo.second;
		assert( graphicsResource != NULL );

		// [ 2 ] - Bind array to texture or surface if needed
		if ( graphicsResource->getMemoryType() == GvRenderer::GvGraphicsResource::eCudaArray )
		{
			...
			{
			case GvRenderer::GvGraphicsInteroperabiltyHandler::eColorReadSlot:
					error = cudaBindTextureToArray( GvRenderer::_inputColorTexture, imageArray );
					break;

				case GvRenderer::GvGraphicsInteroperabiltyHandler::eColorWriteSlot:
				case GvRenderer::GvGraphicsInteroperabiltyHandler::eColorReadWriteSlot:
					error = cudaBindSurfaceToArray( GvRenderer::_colorSurface, imageArray );
					break;

				case GvRenderer::GvGraphicsInteroperabiltyHandler::eDepthReadSlot:
					error = cudaBindTextureToArray( GvRenderer::_inputDepthTexture, imageArray );
					break;

				case GvRenderer::GvGraphicsInteroperabiltyHandler::eDepthWriteSlot:
				case GvRenderer::GvGraphicsInteroperabiltyHandler::eDepthReadWriteSlot:
					error = cudaBindSurfaceToArray( GvRenderer::_depthSurface, imageArray );
					break;
...
::unbindGraphicsResources()
{
	...
	for ( int i = 0; i < graphicsResources.size(); i++ )
	{
		...
		if ( graphicsResource->getMemoryType() == GvRenderer::GvGraphicsResource::eCudaArray )
		{
			...
			{
			case GvRenderer::GvGraphicsInteroperabiltyHandler::eColorReadSlot:
					error = cudaUnbindTexture( GvRenderer::_inputColorTexture );
					break;
				...
				case GvRenderer::GvGraphicsInteroperabiltyHandler::eDepthReadSlot:
					error = cudaUnbindTexture( GvRenderer::_inputDepthTexture );
					break;
...
void RayMapRenderer< VolumeTreeType, VolumeTreeCacheType, ProducerType, SampleShader >
::setRayMapResource( GvRenderer::GvGraphicsResource* pGraphicsResource )
{
