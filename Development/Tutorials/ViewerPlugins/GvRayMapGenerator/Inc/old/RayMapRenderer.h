...
#include <GvStructure/GvDataProduction.h>
#include <GvRenderer/GvIRenderer.h>
#include <GvRenderer/GvVolumeTreeRenderer.h>
#include <GvRenderer/GvGraphicsInteroperabiltyHandler.h>
#include <GvRenderer/GvGraphicsInteroperabiltyHandlerKernel.h>
#include <GvRenderer/GvGraphicsResource.h>
 ...
 */
template<
	typename TVolumeTreeType, typename TVolumeTreeCacheType,
	typename TProducerType, typename TSampleShader >
class RayMapRenderer
	: public GvRenderer::GvIRenderer< RayMapRenderer< TVolumeTreeType, TVolumeTreeCacheType, TProducerType, TSampleShader> >
	, public GvRenderer::GvVolumeTreeRenderer< TVolumeTreeType, TVolumeTreeCacheType, TProducerType >
{
...
public:
	 ...
	 */
	bool connect( GvRenderer::GvGraphicsInteroperabiltyHandler::GraphicsResourceSlot pGraphicsResourceSlot, GLuint pBuffer );
	 ...
	 * @return a flag telling wheter or not it succeeds
	 */
	bool connect( GvRenderer::GvGraphicsInteroperabiltyHandler::GraphicsResourceSlot pGraphicsResourceSlot, GLuint pImage, GLenum pTarget );
	 ...
	 * @return a flag telling wheter or not it succeeds
	 */
	bool disconnect( GvRenderer::GvGraphicsInteroperabiltyHandler::GraphicsResourceSlot pGraphicsResourceSlot );
	 ...
	 * ...
	 */
	void setRayMapResource( GvRenderer::GvGraphicsResource* pGraphicsResource );
...
protected:
	 ...
	 */
	GvRenderer::GvGraphicsInteroperabiltyHandler* _graphicsInteroperabiltyHandler;

	 /**
	  * ...
	  */
	 GvRenderer::GvGraphicsResource* _rayMapResource;
	 ...
	 */
	GvRenderer::GvGraphicsInteroperabiltyHandler* getGraphicsInteroperabiltyHandler();
