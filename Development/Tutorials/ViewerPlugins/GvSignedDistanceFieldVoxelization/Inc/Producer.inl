...
::initialize( TDataStructureType* pDataStructure, TDataProductionManager* pDataProductionManager )
{
	...
	mDistProg = GvUtils::GvShaderManager::createShaderProgram( "Data/Shaders/GvSignedDistanceFieldVoxelization/signedDist_VS.glsl", NULL, "Data/Shaders/VoxelizationSignedDistanceField/signedDist_FS.glsl" );
	GvUtils::GvShaderManager::linkShaderProgram( mDistProg );

	// Initialize shader program
	mPotentialProg = GvUtils::GvShaderManager::createShaderProgram( "Data/Shaders/GvSignedDistanceFieldVoxelization/potentialFunc_VS.glsl", NULL, "Data/Shaders/VoxelizationSignedDistanceField/potentialFunc_FS.glsl" );
