...
/**
 * The depth level difference between neighbor nodes before regularisation.
 */
__constant__ uint cAllowedSubdivisionDifference = 10U;
...
public:
	...
	__device__
	static __forceinline__ uint getNodeFather( TVolTreeKernelType& pVolumeTree, GvStructure::GvNode& pNode, const float3 pSamplePosTree, const uint pMaxNodeDepth );
