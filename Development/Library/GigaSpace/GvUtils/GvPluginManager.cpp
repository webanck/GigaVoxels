 ...
 */
GvPluginManager* GvPluginManager::msInstance = NULL;
 ...
 * GvPluginManager()
 ******************************************************************************/
GvPluginManager::GvPluginManager()
{
}
 ...
 * @return
 ******************************************************************************/
GvPluginManager& GvPluginManager::get()
{
    if ( msInstance == NULL )
    {
        msInstance = new GvPluginManager();
    }
 ...
 * @param pDir
 ******************************************************************************/
void GvPluginManager::loadPlugins( const string& pDir )
{
 ...
 * @param pFilenames
 ******************************************************************************/
void GvPluginManager::getFilenames( const string& pDir, vector< string >& pFilenames ) const
{
#ifdef _WIN32
 ...
 * @return
 ******************************************************************************/
bool GvPluginManager::loadPlugin( const string& pFilename )
{
  ...
  //  GV_CREATE_PLUGIN lFunc = (GV_CREATE_PLUGIN)dlsym( lHandle, "createPlugin" );
    *(void **) (&lFunc) = dlsym( lHandle, "createPlugin" );
    ...
    GvPluginInterface* lPlugin = lFunc( *this );
    if ( lPlugin == NULL )
    {
        return false;
    }
 ...
 * unloadAll()
 ******************************************************************************/
void GvPluginManager::unloadAll()
{
 ...
 * @return
 ******************************************************************************/
size_t GvPluginManager::getNbPlugins() const
{
 ...
 * @return
 ******************************************************************************/
GvPluginInterface* GvPluginManager::getPlugin( int pIndex )
{
