...
class GsGLCacheManager : public GvCore::GvISerializable
{
...
public:
	 ...
	 * There is as many timestamps as elements in the cache.
	 */
	GvCore::Array3DGPULinear< uint >* getElementList() const;
	...
	//---------------------------------------------------------------
	GvCore::Array3DGPULinear< uint >* editUpdateCompactList() { return _d_UpdateCompactList; }
	GvCore::Array3DGPULinear< uint >* editElementAddressList() { return _d_elemAddressList; }
	//---------------------------------------------------------------
...
protected:
	 ...
	 */
	GvCore::Array3DGPULinear< uint >* _d_elemAddressList;
	GvCore::Array3DGPULinear< uint >* _d_elemAddressListTmp;	// tmp buffer

	/**
	 * List of elements (with their requests) to process (each element is unique due to compaction processing)
	 */
	GvCore::Array3DGPULinear< uint >* _d_UpdateCompactList;
