...
#ifndef _GV_NODE_PRODUCTION_HELPER_H_
#define _GV_NODE_PRODUCTION_HELPER_H_
...
#include "GvCache/GvNodeProductionHelperKernel.h"
 ...
 * @ingroup GvCache
 */
class GIGASPACE_EXPORT GvNodeProductionHelper
{
...
public:
	...
	inline void produce( uint pNumElements, uint* pNodesAddressList, uint* pElemAddressList,
...
#include "GvNodeProductionHelper.inl"

#endif // !_GV_NODE_PRODUCTION_HELPER_H_
