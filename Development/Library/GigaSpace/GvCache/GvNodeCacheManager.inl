...
namespace GvCache
{
	...
	const uint GvNodeCacheManager< TDataStructure >::_cNbLockedElements = 1/*null reference*/ + 1/*root node*/;
 ...
 ******************************************************************************/
template< typename TDataStructure >
GvNodeCacheManager< TDataStructure >
::GvNodeCacheManager( const uint3& pCachesize, PageTableArrayType* pPageTableArray, uint pGraphicsInteroperability )
...
,	_policy( eDefaultPolicy )
{
	...
	{
		tmpelemaddress[ index ] = GvNodeCacheManager< TDataStructure >::AddressType::packAddress( pos );
		index++;
	}
 ...
 ******************************************************************************/
template< typename TDataStructure >
GvNodeCacheManager< TDataStructure >::KernelType GvNodeCacheManager< TDataStructure >
::getKernelObject()
{
 ...
 ******************************************************************************/
template< typename TDataStructure >
void GvNodeCacheManager< TDataStructure >
::setPolicy( GvNodeCacheManager< TDataStructure >::ECachePolicy pPolicy )
{
 ...
 ******************************************************************************/
template< typename TDataStructure >
GvNodeCacheManager< TDataStructure >::ECachePolicy GvNodeCacheManager< TDataStructure >
::getPolicy() const
{
	return this->_policy;
}
 ...
 ******************************************************************************/
template< typename TDataStructure >
uint GvNodeCacheManager< TDataStructure >
 ...
 ******************************************************************************/
template< typename TDataStructure >
GvCore::Array3DGPULinear< uint >* GvNodeCacheManager< TDataStructure >
 ...
 ******************************************************************************/
template< typename TDataStructure >
thrust::device_vector< uint >* GvNodeCacheManager< TDataStructure >
 ...
 ******************************************************************************/
//template< typename TDataStructure >
//void GvNodeCacheManager< TDataStructure >::updateSymbols(){
//
...
::invalidateElements( uint numElems, int numValidPageTableSlots )
{
	...
	// Invalidation procedure
	{
		...
		CacheManagerFlagInvalidations< ElementRes, GvNodeCacheManager< TDataStructure >::AddressType >
...

	{
		...
		CacheManagerInvalidatePointers< ElementRes, GvNodeCacheManager< TDataStructure >::AddressType >
 ...
 ******************************************************************************/
template< typename TDataStructure >
inline void GvNodeCacheManager< TDataStructure >
