...
namespace GvCache
{
	...
	const uint GvCacheManager< TId, ElementRes, AddressType, PageTableArrayType, PageTableType >::_cNbLockedElements = 1/*null reference*/ + 1/*root node*/;
 ...
 ******************************************************************************/
template< unsigned int TId, typename ElementRes, typename AddressType, typename PageTableArrayType, typename PageTableType >
GvCacheManager< TId, ElementRes, AddressType, PageTableArrayType, PageTableType >
::GvCacheManager( const uint3& pCachesize, PageTableArrayType* pPageTableArray, uint pGraphicsInteroperability )
...
,	_exceededCapacity( false )
{
	...
	_d_CacheStateBufferArray = new Array3DGPULinear< uchar4 >( make_uint3( this->_numElements, 1, 1 ) );
#endif
 ...
 ******************************************************************************/
template< unsigned int TId, typename ElementRes, typename AddressType, typename PageTableArrayType, typename PageTableType >
GvCacheManagerKernel< ElementRes, AddressType > GvCacheManager< TId, ElementRes, AddressType, PageTableArrayType, PageTableType >
::getKernelObject()
{
 ...
 ******************************************************************************/
template< unsigned int TId, typename ElementRes, typename AddressType, typename PageTableArrayType, typename PageTableType >
void GvCacheManager< TId, ElementRes, AddressType, PageTableArrayType, PageTableType >
::setPolicy( GvCacheManager< TId, ElementRes, AddressType, PageTableArrayType, PageTableType >::ECachePolicy pPolicy )
{
 ...
 ******************************************************************************/
template< unsigned int TId, typename ElementRes, typename AddressType, typename PageTableArrayType, typename PageTableType >
GvCacheManager< TId, ElementRes, AddressType, PageTableArrayType, PageTableType >::ECachePolicy GvCacheManager< TId, ElementRes, AddressType, PageTableArrayType, PageTableType >
::getPolicy() const
{
	return this->_policy;
}
 ...
 ******************************************************************************/
template< unsigned int TId, typename ElementRes, typename AddressType, typename PageTableArrayType, typename PageTableType >
GvCore::Array3DGPULinear< uint >* GvCacheManager< TId, ElementRes, AddressType, PageTableArrayType, PageTableType >
 ...
 ******************************************************************************/
template< unsigned int TId, typename ElementRes, typename AddressType, typename PageTableArrayType, typename PageTableType >
thrust::device_vector< uint >* GvCacheManager< TId, ElementRes, AddressType, PageTableArrayType, PageTableType >
 ...
 ******************************************************************************/
//template< unsigned int TId, typename ElementRes, typename AddressType, typename PageTableArrayType, typename PageTableType >
//void GvCacheManager< TId, ElementRes, AddressType, PageTableArrayType, PageTableType >::updateSymbols(){
//
...
::updateTimeStampsCopy( bool manageUpdatesOnly )
{
	...
	if ( true || this->_lastNumLoads > 0 )
	{
		...
		if ( nbElemToSort > 0 )
		{
			...
			// Get number of non-used elements
	#ifndef GS_USE_OPTIMIZED_NON_BLOCKING_ASYNCHRONOUS_CALLS_PIPELINE_WITH_COMBINED_COPY
			GV_CUDA_SAFE_CALL( cudaMemcpyAsync( &_numElemsNotUsedST, _d_numElementsPtr, sizeof( size_t ), cudaMemcpyDeviceToHost ) );
	#else
			GV_CUDA_SAFE_CALL( cudaMemcpyAsync( &_numElemsNotUsedST, _d_nbValidRequests + cacheId + 1, sizeof( size_t ), cudaMemcpyDeviceToHost ) );
	#endif
		}
		else
		{
 ...
 ******************************************************************************/
template< unsigned int TId, typename ElementRes, typename AddressType, typename PageTableArrayType, typename PageTableType >
inline bool GvCacheManager< TId, ElementRes, AddressType, PageTableArrayType, PageTableType >
 ...
 ******************************************************************************/
template< unsigned int TId, typename ElementRes, typename AddressType, typename PageTableArrayType, typename PageTableType >
inline void GvCacheManager< TId, ElementRes, AddressType, PageTableArrayType, PageTableType >
