...
#ifndef _GV_DATA_STRUCTURE_IO_HANDLER_H_
#define _GV_DATA_STRUCTURE_IO_HANDLER_H_
...
/** 
 * GvDataStructureIOHandler ...
 */
class GIGASPACE_EXPORT GvDataStructureIOHandler
{
...
public:
	 ...
	 */
	GvDataStructureIOHandler( const std::string& pName, 
								unsigned int pLevel,
	...
	GvDataStructureIOHandler( const std::string& pName, 
								unsigned int pLevel,
								unsigned int pBrickWidth,
								const std::vector< GvDataTypeHandler::VoxelDataType >& pDataTypes,
								bool pNewFiles );
...
#pragma warning( disable:4251 )
#endif
	std::vector< GvDataTypeHandler::VoxelDataType > _dataTypes;
#if defined _MSC_VER
#pragma warning( pop )
#endif
	 ...
	 * It corresponds to the childAddress of an GvStructure::GvNode.
...
private:
	 ...
	 */
	GvDataStructureIOHandler( const GvDataStructureIOHandler& );

	/**
	 * Copy operator forbidden.
	 */
	GvDataStructureIOHandler& operator=( const GvDataStructureIOHandler& );
